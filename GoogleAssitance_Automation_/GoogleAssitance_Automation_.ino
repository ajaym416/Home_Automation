...
#define WLAN_SSID       "HUAWEI-Cs5y"// Your SSID
#define WLAN_PASS       "maliciousss"        // Your password
...
Adafruit_MQTT_Subscribe Light2 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/tv");
...
void MQTT_connect() {
  ...
  while ((ret = mqtt.connect()) != 0) { // connect will return 0 for connected
    ...
    Serial.println(F("wifi disconnected, rebooting..."));
    ESP.restart();
